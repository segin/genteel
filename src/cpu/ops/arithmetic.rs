...
pub fn exec_add(cpu: &mut Cpu, size: Size, src: AddressingMode, dst: AddressingMode, direction: bool, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
...
pub fn exec_adda(cpu: &mut Cpu, size: Size, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
...
pub fn exec_addq(cpu: &mut Cpu, size: Size, dst: AddressingMode, data: u8, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_addi(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_subi(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let imm = match size {
        Size::Byte => (cpu.read_word(cpu.pc, memory) & 0xFF) as u32,
        Size::Word => cpu.read_word(cpu.pc, memory) as u32,
        Size::Long => cpu.read_long(cpu.pc, memory),
...
pub fn exec_sub(cpu: &mut Cpu, size: Size, src: AddressingMode, dst: AddressingMode, direction: bool, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_addx(cpu: &mut Cpu, size: Size, src_reg: u8, dst_reg: u8, memory_mode: bool, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_subx(cpu: &mut Cpu, size: Size, src_reg: u8, dst_reg: u8, memory_mode: bool, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = match size {
        Size::Byte | Size::Word => 4,
        Size::Long => 8,
    };
...
pub fn exec_negx(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let (dst_ea, cycles) = calculate_ea(dst, size, &mut cpu.d, &mut cpu.a, &mut cpu.pc, memory);
    let dst_val = cpu.cpu_read_ea(dst_ea, size, memory);
...
pub fn exec_mulu(cpu: &mut Cpu, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
...
pub fn exec_muls(cpu: &mut Cpu, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
    let (src_ea, src_cycles) = calculate_ea(src, Size::Word, &mut cpu.d, &mut cpu.a, &mut cpu.pc, memory);
    cycles += src_cycles;
...
pub fn exec_divu(cpu: &mut Cpu, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
    let (src_ea, src_cycles) = calculate_ea(src, Size::Word, &mut cpu.d, &mut cpu.a, &mut cpu.pc, memory);
    cycles += src_cycles;
...
pub fn exec_divs(cpu: &mut Cpu, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
    let (src_ea, src_cycles) = calculate_ea(src, Size::Word, &mut cpu.d, &mut cpu.a, &mut cpu.pc, memory);
    cycles += src_cycles;
...
pub fn exec_abcd(cpu: &mut Cpu, src_reg: u8, dst_reg: u8, memory_mode: bool, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 6u32;
...
pub fn exec_sbcd(cpu: &mut Cpu, src_reg: u8, dst_reg: u8, memory_mode: bool, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 6u32;
...
pub fn exec_nbcd(cpu: &mut Cpu, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 6u32;
...
pub fn exec_cmp(cpu: &mut Cpu, size: Size, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_cmpa(cpu: &mut Cpu, size: Size, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
    let (src_ea, cycles) = calculate_ea(src, size, &mut cpu.d, &mut cpu.a, &mut cpu.pc, memory);
...
pub fn exec_cmpi(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let imm = match size {
        Size::Byte => (cpu.read_word(cpu.pc, memory) & 0xFF) as u32,
        Size::Word => cpu.read_word(cpu.pc, memory) as u32,
        Size::Long => cpu.read_long(cpu.pc, memory),
...
pub fn exec_cmpm(cpu: &mut Cpu, size: Size, ax: u8, ay: u8, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_tst(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let (dst_ea, cycles) = calculate_ea(dst, size, &mut cpu.d, &mut cpu.a, &mut cpu.pc, memory);
...
pub fn exec_suba(cpu: &mut Cpu, size: Size, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
...
pub fn exec_subq(cpu: &mut Cpu, size: Size, dst: AddressingMode, data: u8, memory: &mut dyn MemoryInterface) -> u32 {
    let (dst_ea, cycles) = calculate_ea(dst, size, &mut cpu.d, &mut cpu.a, &mut cpu.pc, memory);
    let dst_val = cpu.cpu_read_ea(dst_ea, size, memory);
...
pub fn exec_neg(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let (dst_ea, cycles) = calculate_ea(dst, size, &mut cpu.d, &mut cpu.a, &mut cpu.pc, memory);
    let val = cpu.cpu_read_ea(dst_ea, size, memory);
...
pub fn exec_chk(cpu: &mut Cpu, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
