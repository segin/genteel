...
pub fn exec_move(cpu: &mut Cpu, size: Size, src: AddressingMode, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
...
pub fn exec_movea(cpu: &mut Cpu, size: Size, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
...
pub fn exec_lea(cpu: &mut Cpu, src: AddressingMode, dst_reg: u8, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_clr(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_movep(cpu: &mut Cpu, size: Size, reg: u8, an: u8, reg_to_mem: bool, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_movem(cpu: &mut Cpu, size: Size, to_memory: bool, ea: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_pea(cpu: &mut Cpu, src: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
