...
pub fn exec_and(cpu: &mut Cpu, size: Size, src: AddressingMode, dst: AddressingMode, _direction: bool, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
...
pub fn exec_andi(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let imm = match size {
...
pub fn exec_or(cpu: &mut Cpu, size: Size, src: AddressingMode, dst: AddressingMode, _direction: bool, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
...
pub fn exec_ori(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let imm = match size {
        Size::Byte => (cpu.read_word(cpu.pc, memory) & 0xFF) as u32,
        Size::Word => cpu.read_word(cpu.pc, memory) as u32,
        Size::Long => cpu.read_long(cpu.pc, memory),
...
pub fn exec_eor(cpu: &mut Cpu, size: Size, src_reg: u8, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_eori(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let imm = match size {
        Size::Byte => (cpu.read_word(cpu.pc, memory) & 0xFF) as u32,
        Size::Word => cpu.read_word(cpu.pc, memory) as u32,
        Size::Long => cpu.read_long(cpu.pc, memory),
...
pub fn exec_not(cpu: &mut Cpu, size: Size, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let (dst_ea, cycles) = calculate_ea(dst, size, &mut cpu.d, &mut cpu.a, &mut cpu.pc, memory);
...
pub fn exec_shift(cpu: &mut Cpu, size: Size, dst: AddressingMode, count: ShiftCount, left: bool, arithmetic: bool, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_rotate(cpu: &mut Cpu, size: Size, dst: AddressingMode, count: ShiftCount, left: bool, _extend: bool, memory: &mut dyn MemoryInterface) -> u32 {
    let count_val = match count {
        ShiftCount::Immediate(n) => n as u32,
        ShiftCount::Register(r) => cpu.d[r as usize] & 63,
    };
...
pub fn exec_roxl(cpu: &mut Cpu, size: Size, dst: AddressingMode, count: ShiftCount, memory: &mut dyn MemoryInterface) -> u32 {
    let count_val = match count {
        ShiftCount::Immediate(n) => n as u32,
        ShiftCount::Register(r) => cpu.d[r as usize] & 63,
    };
...
pub fn exec_roxr(cpu: &mut Cpu, size: Size, dst: AddressingMode, count: ShiftCount, memory: &mut dyn MemoryInterface) -> u32 {
    let count_val = match count {
        ShiftCount::Immediate(n) => n as u32,
        ShiftCount::Register(r) => cpu.d[r as usize] & 63,
    };
...
pub fn exec_btst(cpu: &mut Cpu, bit: BitSource, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
...
pub fn exec_bset(cpu: &mut Cpu, bit: BitSource, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let bit_num = cpu.fetch_bit_num(bit, memory);
    let is_memory = !matches!(dst, AddressingMode::DataRegister(_));
    let size = if is_memory { Size::Byte } else { Size::Long };
...
pub fn exec_bclr(cpu: &mut Cpu, bit: BitSource, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let bit_num = cpu.fetch_bit_num(bit, memory);
    let is_memory = !matches!(dst, AddressingMode::DataRegister(_));
    let size = if is_memory { Size::Byte } else { Size::Long };
...
pub fn exec_bchg(cpu: &mut Cpu, bit: BitSource, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let bit_num = cpu.fetch_bit_num(bit, memory);
    let is_memory = !matches!(dst, AddressingMode::DataRegister(_));
    let size = if is_memory { Size::Byte } else { Size::Long };
...
pub fn exec_tas(cpu: &mut Cpu, dst: AddressingMode, memory: &mut dyn MemoryInterface) -> u32 {
    let mut cycles = 4u32;
