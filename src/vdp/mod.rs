...
impl<'a> Iterator for SpriteIterator<'a> {
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        // Optimization: Read all 8 bytes of sprite attribute data at once
        // SAFETY: The bounds check above (addr + 8 > 0x10000) ensures this slice access is valid.
        let bytes = &self.vram[addr..addr + 8];
