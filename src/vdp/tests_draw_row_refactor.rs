...
fn test_draw_full_tile_row_refactor() {
    ...
    // Check pixels
    assert_eq!(line_buf[0], 0x01, "Pixel 0");
    assert_eq!(line_buf[1], 0x01, "Pixel 1");
    assert_eq!(line_buf[2], 0x00, "Pixel 2");
}
...
fn test_draw_full_tile_row_hflip() {
    ...
    assert_eq!(line_buf[7], 0x01, "Pixel 7 should be Red (1)");
    assert_eq!(line_buf[6], 0x02, "Pixel 6 should be Green (2)");
    assert_eq!(line_buf[0], 0x00, "Pixel 0 should be empty");
}
