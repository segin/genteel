...
impl Bus {
    ...
    fn write_vdp_area(&mut self, addr: u32, value: u8) {
        match addr {
            0xC00000..=0xC00003 => {} // VDP data port (word only)
            0xC00004..=0xC00007 => {} // VDP control port (word only)
