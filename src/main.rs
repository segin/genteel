...
impl Emulator {
    ...
    pub fn execute_script_command(&mut self, cmd: &str) {
                ...
                "ASSERT_BYTE" => {
                    if parts.len() > 2 {
                        ...
                        if let (Ok(addr), Ok(expected)) = (addr_res, val_res) {
                            ...
                            println!("Script: ASSERT_BYTE 0x{:06X} == 0x{:02X} OK", addr, expected);
                        }
                    }
                }
                "READ_WORD" => {
                ...
                "ASSERT_WORD" => {
                    if parts.len() > 2 {
                        ...
                        if let (Ok(addr), Ok(expected)) = (addr_res, val_res) {
                            ...
                            println!("Script: ASSERT_WORD 0x{:06X} == 0x{:04X} OK", addr, expected);
                        }
                    }
                }
                "READ_LONG" => {
                ...
                "ASSERT_LONG" => {
                    if parts.len() > 2 {
                        ...
                        if let (Ok(addr), Ok(expected)) = (addr_res, val_res) {
                            ...
                            println!("Script: ASSERT_LONG 0x{:06X} == 0x{:08X} OK", addr, expected);
                        }
                    }
                }
                "LOG" => {
