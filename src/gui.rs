...
pub struct DebugInfo {
    ...
    pub m68k_usp: u32,
    pub m68k_ssp: u32,
    pub m68k_disasm: Vec<(u32, Cow<'static, str>)>,
    pub z80_pc: u16,
    pub z80_a: u8,
    pub z80_f: u8,
    pub z80_b: u8,
    ...
    pub z80_iff1: bool,
    pub z80_im: u8,
    pub z80_disasm: Vec<(u16, Cow<'static, str>)>,
    pub frame_count: u64,
    pub vdp_status: u16,
                ...
                .show(&self.egui_ctx, |ui| {
                                ...
                                |ui, row_range| {
                                    egui::Grid::new("vram_grid").show(ui, |ui| {
                                        ...
                                        for row in row_range {
                                            let addr = row * 16;
                                            addr_buf.clear();
                                            let _ = write!(&mut addr_buf, "{:04X}:", addr);
                                            ui.label(egui::RichText::new(&addr_buf).monospace());
                                            for i in 0..16 {
                                                let val = debug_info.vram[addr + i];
                                                ui.label(egui::RichText::new(HEX_LOOKUP[val as usize]).monospace());
                                            }
                                            ui.end_row();
                                        }
                                    });
                    ...
                    ui.collapsing("CRAM", |ui| {
                        egui::Grid::new("cram_grid").show(ui, |ui| {
                            let mut addr_buf = String::with_capacity(4);
                            for row in 0..4 {
                                let addr = row * 16;
                                addr_buf.clear();
                                let _ = write!(&mut addr_buf, "{:02X}:", addr);
                                ui.label(egui::RichText::new(&addr_buf).monospace());
                                for i in 0..16 {
                    ...
                    ui.collapsing("VSRAM", |ui| {
                        egui::Grid::new("vsram_grid").show(ui, |ui| {
                            ...
                            for row in 0..5 {
                                ...
                                for i in 0..16 {
                                    if addr + i < 80 {
                                        let val = debug_info.vsram[addr + i];
                                        ui.label(egui::RichText::new(HEX_LOOKUP[val as usize]).monospace());
                                    } else {
                                        ui.label("  ");
                                    }
                                ...
                                |ui, row_range| {
                                    egui::Grid::new("wram_grid").show(ui, |ui| {
                                        ...
                                        for row in row_range {
                                            ...
                                            ui.label(egui::RichText::new(&addr_buf).monospace());
                                            for i in 0..16 {
                                                let val = debug_info.wram[addr + i];
                                                ui.label(egui::RichText::new(HEX_LOOKUP[val as usize]).monospace());
                                            }
                                            ui.end_row();
                                        }
                                ...
                                |ui, row_range| {
                                    egui::Grid::new("z80_ram_grid").show(ui, |ui| {
                                        ...
                                        for row in row_range {
                                            ...
                                            ui.label(egui::RichText::new(&addr_buf).monospace());
                                            for i in 0..16 {
                                                let val = debug_info.z80_ram[addr + i];
                                                ui.label(egui::RichText::new(HEX_LOOKUP[val as usize]).monospace());
                                            }
                                            ui.end_row();
                                        }
                            ...
                            let debug_info = {
                                ...
                                let m68k_disasm = {
                                    ...
                                    for _ in 0..10 {
                                        ...
                                        disasm.push((addr, Cow::Owned(format!("{:?}", instr))));
                                ...
                                let z80_disasm = {
                                    ...
                                    for _ in 0..10 {
                                        ...
                                        disasm.push((addr, Cow::Borrowed(HEX_LOOKUP[byte as usize])));
                                        addr += 1;
                                    }
                                    disasm
                                };
