...
#[test] fn sll_b_00() { let mut c = z80(&[0xCB, 0x30]); c.b = 0x00; c.step(); assert_eq!(c.b, 0x01); assert!(!c.get_flag(flags::CARRY)); }
#[test] fn sll_b_01() { let mut c = z80(&[0xCB, 0x30]); c.b = 0x01; c.step(); assert_eq!(c.b, 0x03); }
#[test] fn sll_b_80() { let mut c = z80(&[0xCB, 0x30]); c.b = 0x80; c.step(); assert_eq!(c.b, 0x01); assert!(c.get_flag(flags::CARRY)); }
#[test] fn sll_b_ff() { let mut c = z80(&[0xCB, 0x30]); c.b = 0xFF; c.step(); assert_eq!(c.b, 0xFF); assert!(c.get_flag(flags::CARRY)); }
#[test] fn sll_c() { let mut c = z80(&[0xCB, 0x31]); c.c = 0x55; c.step(); assert_eq!(c.c, 0xAB); }
#[test] fn sll_d() { let mut c = z80(&[0xCB, 0x32]); c.d = 0xAA; c.step(); assert_eq!(c.d, 0x55); assert!(c.get_flag(flags::CARRY)); }
...
#[test] fn neg_44() { let mut c = z80(&[0xED, 0x44]); c.a = 0x01; c.step(); assert_eq!(c.a, 0xFF); }
#[test] fn neg_4c() { let mut c = z80(&[0xED, 0x4C]); c.a = 0x01; c.step(); assert_eq!(c.a, 0xFF); }
#[test] fn neg_54() { let mut c = z80(&[0xED, 0x54]); c.a = 0x01; c.step(); assert_eq!(c.a, 0xFF); }
#[test] fn neg_5c() { let mut c = z80(&[0xED, 0x5C]); c.a = 0x01; c.step(); assert_eq!(c.a, 0xFF); }
#[test] fn neg_64() { let mut c = z80(&[0xED, 0x64]); c.a = 0x01; c.step(); assert_eq!(c.a, 0xFF); }
#[test] fn neg_6c() { let mut c = z80(&[0xED, 0x6C]); c.a = 0x01; c.step(); assert_eq!(c.a, 0xFF); }
#[test] fn neg_74() { let mut c = z80(&[0xED, 0x74]); c.a = 0x01; c.step(); assert_eq!(c.a, 0xFF); }
...
#[test] fn im0_4e() { let mut c = z80(&[0xED, 0x4E]); c.step(); assert_eq!(c.im, 0); }
#[test] fn im0_66() { let mut c = z80(&[0xED, 0x66]); c.step(); assert_eq!(c.im, 0); }
#[test] fn im0_6e() { let mut c = z80(&[0xED, 0x6E]); c.step(); assert_eq!(c.im, 0); }
#[test] fn im1_56() { let mut c = z80(&[0xED, 0x56]); c.step(); assert_eq!(c.im, 1); }
#[test] fn im1_76() { let mut c = z80(&[0xED, 0x76]); c.step(); assert_eq!(c.im, 1); }
#[test] fn im2_5e() { let mut c = z80(&[0xED, 0x5E]); c.step(); assert_eq!(c.im, 2); }
#[test] fn im2_7e() { let mut c = z80(&[0xED, 0x7E]); c.step(); assert_eq!(c.im, 2); }
