...
fn test_ex_sp_hl_memptr_and_flags() {
    ...
    cpu.memory.write_byte(0x1000, 0xCD);
    cpu.memory.write_byte(0x1001, 0xAB);
    ...
    assert_eq!(cpu.memory.read_byte(0x1000), 0x34);
    assert_eq!(cpu.memory.read_byte(0x1001), 0x12);
...
fn test_ex_sp_ix_memptr_and_flags() {
    ...
    cpu.memory.write_byte(0x2000, 0xBC);
    cpu.memory.write_byte(0x2001, 0x9A);
    ...
    assert_eq!(cpu.memory.read_byte(0x2000), 0x78);
    assert_eq!(cpu.memory.read_byte(0x2001), 0x56);
...
fn test_ex_sp_iy_memptr_and_flags() {
    ...
    cpu.memory.write_byte(0x3000, 0xEF);
    cpu.memory.write_byte(0x3001, 0xBE);
    ...
    assert_eq!(cpu.memory.read_byte(0x3000), 0xAD);
    assert_eq!(cpu.memory.read_byte(0x3001), 0xDE);
...
proptest! {
    ...
    fn prop_ex_sp_hl_swaps_correctly(hl_val in 0u16..=0xFFFF, sp_val in 2u16..=0xFFFE, mem_val in 0u16..=0xFFFF) {
        ...
        cpu.set_hl(hl_val);
        // Write Little Endian
        cpu.memory.write_byte(sp_val as u32, mem_val as u8);
        cpu.memory.write_byte((sp_val as u32).wrapping_add(1), (mem_val >> 8) as u8);

        cpu.step();

        prop_assert_eq!(cpu.hl(), mem_val);
        // Check memory explicitly byte by byte for Little Endian
        prop_assert_eq!(cpu.memory.read_byte(sp_val as u32), hl_val as u8);
        prop_assert_eq!(cpu.memory.read_byte((sp_val as u32).wrapping_add(1)), (hl_val >> 8) as u8);
    ...
    fn prop_ex_sp_ix_swaps_correctly(ix_val in 0u16..=0xFFFF, sp_val in 2u16..=0xFFFE, mem_val in 0u16..=0xFFFF) {
        ...
        // Check memory
        prop_assert_eq!(cpu.memory.read_byte(sp_val as u32), ix_val as u8);
        prop_assert_eq!(cpu.memory.read_byte((sp_val as u32).wrapping_add(1)), (ix_val >> 8) as u8);
        prop_assert_eq!(cpu.memptr, mem_val);
    }
    ...
    fn prop_ex_sp_iy_swaps_correctly(iy_val in 0u16..=0xFFFF, sp_val in 2u16..=0xFFFE, mem_val in 0u16..=0xFFFF) {
        ...
        // Check memory
        prop_assert_eq!(cpu.memory.read_byte(sp_val as u32), iy_val as u8);
        prop_assert_eq!(cpu.memory.read_byte((sp_val as u32).wrapping_add(1)), (iy_val >> 8) as u8);
        prop_assert_eq!(cpu.memptr, mem_val);
    }
}
