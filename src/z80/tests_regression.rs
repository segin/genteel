...
// Z80 Hardware Behavior: DAA not handling N flag correctly
#[test]
...
// Z80 Hardware Behavior: DJNZ not decrementing B before the test
#[test]
...
// Z80 Hardware Behavior: DJNZ wrapping behavior (decrement then test)
#[test]
...
// Z80 Hardware Behavior: JR displacement is signed
#[test]
...
// Z80 Hardware Behavior: LD (HL), H/L uses new value after HL is modified
#[test]
...
// Z80 Hardware Behavior: PUSH/POP AF not preserving all flag bits
#[test]
...
// Z80 Hardware Behavior: EX (SP), HL not swapping correctly
#[test]
...
// Z80 Hardware Behavior: INC/DEC not affecting V flag correctly
...
// Z80 Hardware Behavior: SCF/CCF H flag behavior
#[test]
...
// Z80 Hardware Behavior: NEG with A=0x80 causes overflow
#[test]
...
// Z80 Hardware Behavior: ADD HL, SP affects only C and H flags
#[test]
...
// Z80 Hardware Behavior: BIT instruction H flag should always be set
#[test]
...
// Z80 Hardware Behavior: RLC/RRC/RL/RR should affect all flags correctly
#[test]
...
// Z80 Hardware Behavior: SBC HL, BC with no carry shouldn't borrow
#[test]
