...
// Emulator Regression: DAA not handling N flag correctly
#[test]
...
// Emulator Regression: JR displacement is signed
#[test]
...
// Hardware edge case: INC/DEC not affecting V flag correctly
...
// Emulator Regression: NEG with A=0x80 causes overflow
#[test]
...
// Z80 Hardware Edge Case: LD A, I/R should set P/V from IFF2
#[test]
...
// Emulator Regression: ADD HL, SP affects only C and H flags
#[test]
...
// Emulator Regression: RLC/RRC/RL/RR should affect all flags correctly
#[test]
...
// Emulator Regression: SBC HL, BC with no carry shouldn't borrow
#[test]
